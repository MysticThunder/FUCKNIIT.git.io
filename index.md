<!DOCTYPE html>
<html>
<head><title>【申请】学生请销假申请</title>
    <meta charset="utf-8">
    <meta name="renderer" content="webkit|ie-comp|ie-stand">
    <meta http-equiv="X-UA-Compatible" content="IE=edge; chrome=1">
    <meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <link href="https://assets.jiandaoyun.com/" rel="preconnect">
    <link href="https://assets.jiandaoyun.com/" rel="dns-prefetch">
    <link href="https://assets.jiandaoyun.com/mobile/jdy-design.a9daf19935d09e8c1c18.css" rel="stylesheet">
    <link href="https://assets.jiandaoyun.com/mobile/components.a9daf19935d09e8c1c18.css" rel="stylesheet">
    <link href="https://assets.jiandaoyun.com/mobile/flow-data.a9daf19935d09e8c1c18.css" rel="stylesheet">
    <style type="text/css">
        /*! CSS Used from: https://assets.jiandaoyun.com/mobile/jdy-design.a9daf19935d09e8c1c18.css */
        *{box-sizing:border-box;}
        *::before,*::after{box-sizing:border-box;}
        html{height:100%;font-size:20px;-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;-ms-text-size-adjust:100%;text-size-adjust:100%;}
        body{position:relative;height:100%;margin:0;padding:0;color:#1F2D3D;font-size:0.75rem;font-family:"Helvetica Neue", Helvetica, "PingFang SC", Roboto, "Noto Sans CJK SC", "Hiragino Sans GB", "Microsoft YaHei", "Microsoft Yahei", Arial, sans-serif;-webkit-tap-highlight-color:rgba(0, 0, 0, 0);}
        ...
        input{margin:0;padding:0.15rem 0.3rem;color:#1F2D3D;font-family:sans-serif;vertical-align:middle;border:1px solid #D9D9D9;outline:none;}
        input::-webkit-input-placeholder{color:#C3CDDA;}
        input::-moz-placeholder{color:#C3CDDA;}
        input:-ms-input-placeholder{color:#C3CDDA;}
        input::-ms-input-placeholder{color:#C3CDDA;}
        input::placeholder{color:#C3CDDA;}
        input{font-size:0.75rem;-webkit-appearance:none;-moz-appearance:none;appearance:none;}
        img{border:0;outline:none;}
        ul{margin:0;padding:0;}
        li{list-style-type:none;}
        .x-button{height:1.75rem;padding:0 1rem;font-size:0.75rem;border-radius:1rem;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;}
        .x-button .text{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
        .x-button > .icon{margin:0 0.25rem;font-size:0.8rem;}
        .x-button.type-secondary{color:#5E6D82;background:#fff;border:solid 1px #E9E9E9;}
        .x-button.type-secondary:not(.disabled):not(.loading):active{background:#E9E9E9;}
        .x-list-item{padding:1rem 0.5rem;background:white;border-bottom:solid 1px #E9E9E9;display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;}
        .x-list-item:active{background:#F1F1F1;}
        .x-list-item:last-child{border-bottom:none;}
        .x-list-item .list-item-content{-webkit-box-flex:1;flex:auto;overflow:hidden;}
        .x-tab .tab-header{position:relative;height:3rem;}
        .x-tab .tab-header::before{position:absolute;right:0;bottom:0;left:0;display:block;height:1px;background:#E9E9E9;content:'';}
        .x-tab .tab-header .tab-header-wrapper{display:-webkit-box;display:flex;height:100%;}
        .x-tab .tab-header .tab-header-wrapper .tab-header-item{position:relative;-webkit-box-flex:1;flex:auto;width:100%;overflow:hidden;display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;}
        .x-tab .tab-header .tab-header-wrapper .tab-header-item .tab-header-content{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
        ...
        .fxm-form-textarea-data{min-height:1.25rem;padding:0.5rem 0 0.5rem 0.5rem;overflow:auto;line-height:1.25rem;word-wrap:break-word;word-break:break-all;}
        ...
        .fxm-flow-log-list .log-item{position:relative;padding:0.55rem 0.55rem 0.75rem;background:#fff;border-bottom:none;}
        ...
        .fxm-flow-data-wrapper .wrapper-content .content-item{position:relative;padding:0;background:#F4F4F4;width:100%;height:100%;}
                        ...
                        <div class="fxm-form-data">
                            <div class="widget-wrapper">
                                ...
                                <div class="widget-data-view" data-widgetname="_widget_1600413600383">
                                    ...
                                    <div class="widget-data">
                                        <div class="fxm-form-text-data fxm-form-view">2020</div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-header content-header theme-modern need-swipe">
                                <div class="tab-header-wrapper" style="transform: translateX(0px);">
                                    <div class="tab-header-item active" id="spyj"
                                        ...
                                        <div class="tab-header-content">审批意见</div>
                                    </div>
...
<script src="https://assets.jiandaoyun.com/mobile/manifest.a9daf19935d09e8c1c18.js"></script>
<script src="https://assets.jiandaoyun.com/mobile/utils.a9daf19935d09e8c1c18.js"></script>
<script src="https://assets.jiandaoyun.com/mobile/jdy-design.a9daf19935d09e8c1c18.js"></script>
<script src="https://assets.jiandaoyun.com/mobile/react.a9daf19935d09e8c1c18.js"></script>
<script src="https://assets.jiandaoyun.com/mobile/components.a9daf19935d09e8c1c18.js"></script>
<script src="https://assets.jiandaoyun.com/mobile/common.a9daf19935d09e8c1c18.js"></script>
<script src="https://assets.jiandaoyun.com/mobile/plugins.a9daf19935d09e8c1c18.js"></script>
</body>
</html>
